...
# REGRESSION_DATASET = ['196_autoMpg', '26_radon_seed_dataset']
...
# SEMI_SUPERVISED_DATASET = [ 'SEMI_1217_click_dataset']
TIMESERIES_DATASET = ['stock_market', '56_sunspots_monthly', 'LL1_crime_chicago', '57_sunspot']
# TIMESERIES_DATASET = ['LL1_crime_chicago']
...
# SUMMARIZATION_PROMPT = ['fewshot+instruction']
