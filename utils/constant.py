...
CLASSIFICATION_DATASET = ['299_libras_move', '185_baseball_dataset']
...
SUMMARIZATION_FLAT_PROMPT = ['zeroshot']
...
PROMPT_STRATEGY = ['FLAT_PROMPTING', 'HIERARCHICAL_PROMPTING']