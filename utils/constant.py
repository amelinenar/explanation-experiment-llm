...
CLASSIFICATION_DATASET = ['1491_one_hundred_plants']
...
SUMMARIZATION_FLAT_PROMPT = ['zeroshot', 'zeroshot_instruction', 'fewshot', 'chain_of_thought','zeroshot_CoT','fewshot+instruction']
SUMMARIZATION_HIERARCHICAL_PROMPT = ['Hierachical prompt']
...
AUTOML = ['ALPHA-AUTOML', 'AUTOSKLEARN']
PROMPT_STRATEGY = [ 'HIERARCHICAL_PROMPTING', 'FLAT_PROMPTING']